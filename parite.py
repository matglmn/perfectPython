...
def parse_arguments():
    ...
    parser.add_argument("-d", "--datafile", help="""File containing information you want to display""")
    parser.add_argument("-e", "--extension", help="""Type of file to analyse. Is it a CSV or and XML ?""")
